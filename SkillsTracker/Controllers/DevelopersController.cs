...
namespace SkillsTracker.Controllers
{
    public class DevelopersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,name,nickname")] Developer developer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,name,nickname")] Developer developer)
        {
            if (ModelState.IsValid)
            {
